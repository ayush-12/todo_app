...
abstract class $ReminderCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool enabled, @TimestampConverter() DateTime? reminderDate});
}
...
class _$ReminderImpl implements _Reminder {
  const _$ReminderImpl(
      {this.enabled = false, @TimestampConverter() this.reminderDate});
  ...
  @override
  String toString() {
    return 'Reminder(enabled: $enabled, reminderDate: $reminderDate)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, enabled, reminderDate);
...
abstract class _Reminder implements Reminder {
  const factory _Reminder(
      {final bool enabled,
      @TimestampConverter() final DateTime? reminderDate}) = _$ReminderImpl;
